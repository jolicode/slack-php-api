...
class ChannelsHistoryGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JoliCode\\Slack\\Api\\Model\\ChannelsHistoryGetResponse200' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && 'JoliCode\\Slack\\Api\\Model\\ChannelsHistoryGetResponse200' === \get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('is_limited', $data) && null !== $data['is_limited']) {
            $object->setIsLimited($data['is_limited']);
        } elseif (\array_key_exists('is_limited', $data) && null === $data['is_limited']) {
            $object->setIsLimited(null);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getIsLimited()) {
            $data['is_limited'] = $object->getIsLimited();
        } else {
            $data['is_limited'] = null;
        }
