...
class ObjsConversationItem1DisplayCountsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'JoliCode\\Slack\\Api\\Model\\ObjsConversationItem1DisplayCounts' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && 'JoliCode\\Slack\\Api\\Model\\ObjsConversationItem1DisplayCounts' === \get_class($data);
    }
