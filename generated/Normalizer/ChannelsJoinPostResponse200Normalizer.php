...
class ChannelsJoinPostResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'JoliCode\\Slack\\Api\\Model\\ChannelsJoinPostResponse200';
    }

    public function supportsNormalization($data, $format = null)
    {
        return get_class($data) === 'JoliCode\\Slack\\Api\\Model\\ChannelsJoinPostResponse200';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $data = clone $data;
        if (property_exists($data, 'already_in_channel') && $data->{'already_in_channel'} !== null) {
            $object->setAlreadyInChannel($data->{'already_in_channel'});
            unset($data->{'already_in_channel'});
        }
