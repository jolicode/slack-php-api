...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class FilesGetUploadURLExternalGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return \JoliCode\Slack\Api\Model\FilesGetUploadURLExternalGetResponse200::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && \JoliCode\Slack\Api\Model\FilesGetUploadURLExternalGetResponse200::class === \get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \JoliCode\Slack\Api\Model\FilesGetUploadURLExternalGetResponse200();
        ...
        {
            return [\JoliCode\Slack\Api\Model\FilesGetUploadURLExternalGetResponse200::class => false];
        }
    }
} else {
    class FilesGetUploadURLExternalGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
