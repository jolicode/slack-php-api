...
class ChatPostMessage extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Endpoint
{
    ...
    protected function getFormOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['attachments', 'unfurl_links', 'text', 'unfurl_media', 'parse', 'as_user', 'mrkdwn', 'channel', 'blocks', 'icon_emoji', 'link_names', 'reply_broadcast', 'thread_ts', 'username', 'icon_url']);
